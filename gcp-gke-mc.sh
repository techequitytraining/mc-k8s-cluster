...
export SERVICEMESH_VERSION=1.20.6-asm.0
...
if [ $MODE -eq 1 ]; then
    ...
    echo
    echo "$ gcloud services enable --project=\$GCP_PROJECT container.googleapis.com gkeconnect.googleapis.com gkehub.googleapis.com cloudresourcemanager.googleapis.com iam.googleapis.com anthosidentityservice.googleapis.com connectgateway.googleapis.com anthos.googleapis.com # to enable APIs" | pv -qL 100
    echo
    ...
    echo
    echo "$ gcloud services enable --project=$GCP_PROJECT container.googleapis.com gkeconnect.googleapis.com gkehub.googleapis.com cloudresourcemanager.googleapis.com iam.googleapis.com anthosidentityservice.googleapis.com connectgateway.googleapis.com anthos.googleapis.com # to enable APIs" | pv -qL 100
    gcloud services enable --project=$GCP_PROJECT container.googleapis.com gkeconnect.googleapis.com gkehub.googleapis.com cloudresourcemanager.googleapis.com iam.googleapis.com anthosidentityservice.googleapis.com connectgateway.googleapis.com anthos.googleapis.com
    echo
